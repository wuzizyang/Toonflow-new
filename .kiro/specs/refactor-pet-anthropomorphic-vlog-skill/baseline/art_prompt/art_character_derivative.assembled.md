...
2. **姿态不变** — 保持底模动物自然后腿立起姿态（含背微弓、前爪收胸前、短腿），禁止任何姿态/动作/体态变化
...
> **宠物服饰原则**：以下均为**宠物专用服饰**（为动物身形设计、贴合兽体、为四肢尾巴预留位）；以上身/披挂为主，下半身保留覆毛短腿。
...
| 部位 | **以上半身着装为主**，下半身默认保留动物覆毛短腿、不穿长裤（避免人腿剪影） | 上装为主、furry short legs、pet-style lower body |
...
| 布局 | 同一画面从左至右并排四视图 |
| 背景 | 纯净中性灰 #E8E8E8 |
| 站姿 | 动物自然后腿立起、含背微弓、短腿、前爪收胸前或轻搭身侧（**禁止任何姿态变化**） |
...
photorealistic anthropomorphic pet character，vlog selfie look，natural ambient light，natural realistic colors，
