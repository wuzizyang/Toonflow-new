...
| **Seedance 2.0（中文）** | `宠物拟人化，真实兽态（大头短身、含背微弓、短小四肢、真实前爪、趾行爪足），姿态随动作：用手操作时后腿坐起/立起+前爪操作，走路移动时自然四足兽态（绝不直立行走），宠物专用服饰，下半身覆毛兽腿，呆萌可爱、圆润大眼无辜神态，照片级写实真实摄影日常生活随拍质感，自然日常光照，逐根真实毛发，次表面散射，真实生活Vlog氛围` | | |
